...
;20001000 knapptryck
;20002000 riktning pÃ¥ bollen
;20003000 poÃ¤ng vÃ¤nster
;20004000 poÃ¤ng hÃ¶ger
...
mainloop:            ; Remove
	...
	mov r3 ,  #0x22 ;arbitrary value, not 0x00 or 0xFF
	str r3, [r2]
	mov r1, #750
	bl DELAY
...
intgpiod:
	...
	mov r1,#(1<<7)
	str r1,[r0]
	mov r2,#(0x20001000 & 0xffff) ;spara knapptryck frÃ¥n hÃ¶ger spelare
	movt r2,#(0x20001000 >> 16)
	mov r3, #0xFF
	str r3, [r2]
...
intgpioe:
	...
	mov r1,#(1<<4)
	str r1,[r0]
	mov r2,#(0x20001000 & 0xffff) ;spara knapptryck frÃ¥n vÃ¤nster spelare
	movt r2,#(0x20001000 >> 16)
	mov r3, #0x00
	str r3, [r2]
	bx lr
